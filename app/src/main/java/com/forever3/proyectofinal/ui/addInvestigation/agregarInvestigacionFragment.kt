 ...
 * Use the [agregarInvestigacionFragment.newInstance] factory method to
...
class agregarInvestigacionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment addInvestigationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            agregarInvestigacionFragment().apply {
